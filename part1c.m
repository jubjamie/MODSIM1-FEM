...
Problem=newProblem; % Init an empty Problem object.
Problem.mesh=OneDimLinearMeshGen(0,1,4); % Define the mesh with 4 elements x=0<>1
Problem.Diffusion.coef=1; % Set a diffusion coefficient of 1.
Problem.BCS.D=[[2,0];[0,1];]; % Define Dirichlet Boundaries-> c=2@x=0 & c=0@x=1

Problem.Solve(); % Send Problem to FEM Solver.
