...
opts.TolFun = 1e-8; %Tolerance on the error
opts.MaxIter = 50; %Max number of iterations
[x, diff, exitflag] = fminsearchbnd(@(x)burnCostFunction(x,P2), [333.15], [315.15], [393.15], opts);
