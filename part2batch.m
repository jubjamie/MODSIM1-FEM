...
f4=figure('pos',[400,400,820,475],'Name',...
    'Temperature Profile - Part 2a - Varying TL');
...
holdPvalue=(((Batch{1}.BatchOptions.UB(holdPterm)-...
    ...
    (Batch{1}.BatchOptions.STEPS(holdPterm)-1))*...
    (holdPindex-1))+Batch{1}.BatchOptions.LB(holdPterm);
title(['Part 2a Temperature Profile as TL Only Varies. Q='...
    num2str(holdPvalue)]);
...
f5=figure('pos',[400,400,820,475],'Name',...
    'Temperature Profile - Part 2a - Varying Q');
...
holdPvalue=(((Batch{1}.BatchOptions.UB(holdPterm)-...
    ...
    (Batch{1}.BatchOptions.STEPS(holdPterm)-1))*...
    (holdPindex-1))+Batch{1}.BatchOptions.LB(holdPterm);
title(['Part 2a Temperature Profile as Q Only Varies. TL='...
    num2str(holdPvalue)]);
% Dispaly the colorbar before saving.
colorbar;
